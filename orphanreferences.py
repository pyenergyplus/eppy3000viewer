...
# =======================================================================
"""track the orphan references - pasted in orphan_references.txt"""
...
if __name__ == '__main__':
    ...
    # fname = '/Applications/EnergyPlus-9-0-1/Energy+.schema.epJSON'
    # fname = '/Applications/EnergyPlus-9-5-0/Energy+.schema.epJSON'
    # fname = '/Applications/EnergyPlus-9-6-0/Energy+.schema.epJSON'
    print()
    print(fname)
    print('=' * len(fname))
    sub = "The orphaned references are:"
    print(sub)
    print('-' * len(sub))
